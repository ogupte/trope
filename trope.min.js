...
q["?"]).apply(q,a);return k(a)}var l="function",m="prototype",v="constructor",r=function(){},s=function(){},B=1296124227,A=1296124233,z=1296124225,C=function(a){var b=a.length,c,h;for(c=0;c<b;c++)h=a[c],a.push(h.charAt(0).toUpperCase()+h.substr(1));return a}("class proto alter alt turn extend ext modify mod link chain draft denote outline cast exhibit model compound enhance".split(" ")),D=function(){Error("No Super Function Found.")};g.prototype={push:function(a,b,c){this.stack.push({executionContext:a,
type:b,data:c})},pop:function(){return this.stack.pop()},peek:function(){return this.stack[this.stack.length-1]}};g.create=function(){return g(Object.create(g.prototype))};f.create=function(a,b,c,h){return f(Object.create(f.prototype),a,b,c,h)};f.prototype={as:function(a){return f.create(a,this.pubCtx,this.privateCtx,this.executionStack)},hasSuper:function(){return this.trope.superConstr?!0:!1},overrideMethod:function(a,b,c){var h=this,d;h.pubCtx.hasOwnProperty&&h.pubCtx.hasOwnProperty(a)&&(d=h.pubCtx[a]);
h.pubCtx[a]=function(){var e=arguments,f=h;c&&(f=h.as(c));h.executionStack.push(f,12800,{name:a,superMethod:d});e=b.apply(f.getTargetContext(),e);h.executionStack.pop();return e}},getPublicContext:function(){return this.pubCtx},getPrivateContext:function(){return this.privateCtx},getTargetContext:function(){return this.trope.isPrivate?this.privateCtx:this.pubCtx},callWithContext:function(a,b,c,d){this.executionStack.push(this,a,d);a=b(c);this.executionStack.pop();return a},getAsMemberFunction:function(a,
b,c,d){var e=this,x=e.targetCtx,f=13056;!1===c?x=e.pubCtx:!0===c&&(x=e.privateCtx,d&&(f=13312));return function(){var c=arguments,d;e.callWithContext(f,function(a){d=b.apply(a,c)},x,{name:a});return d}},getAsPublicMethod:function(a,b){return this.getAsMemberFunction(a,b,!1,!0)},getAsPrivateMethod:function(a,b){return this.getAsMemberFunction(a,b,!0,!0)},getMethod:function(a){var b=this.trope.methodMap[a];return this.as(b.trope).getAsMemberFunction(a,b.func)},getPrivateMethod:function(a){var b=this.trope.privateMethodMap[a];
return this.as(b.trope).getAsPrivateMethod(a,b.func)},callAsConstructor:function(a){return this.callWithContext(12288,a,this.targetCtx)},getParentContextualFunction:function(){if(this.trope.inherits)return this.as(this.trope.inherits).getContextualFunction()},getSuperFunction:function(){return this.executionStack.peek().executionContext.getParentContextualFunction()},getContextualFunction:function(){var a=this.executionStack.peek(),b;if(a){b=a.type;a=a.data;if(12288===b)return this.getConstructor();
if(12800===b)return a.superMethod;if(13056===b)return this.getMethod(a.name);if(13312===b)return this.getPrivateMethod(a.name)}},getConstructor:function(){var a=this;return function(){var b=arguments;a.callAsConstructor(function(c){a.trope.constr.apply(c,b)})}}};e.prototype={getConstructor:function(){var a=this;return function(b){b.prototype=a.finalProto;b.trope=a;b.create=function(){return b.apply(null,arguments)};y(b,C,a.extend.bind(a));return b}(a.buildProxyConstructor())},buildProxyConstructor:function(){var a=
this;return function(){var b=arguments,c=f.create(a),d=c.getPublicContext(),e=c.getPrivateContext();a.useSuper&&d.hasOwnProperty&&!d.hasOwnProperty("super")&&Object.defineProperty(d,"super",{enumerable:!1,get:function(){var b=D;a.inherits&&(b=c.getSuperFunction());b&&(b.as=function(a){return c.as(a).getContextualFunction()});return b}});Object.keys(a.methodMap).forEach(function(b){var e=a.methodMap[b];u(d,b,c.as(e.trope).getAsMemberFunction(b,e.func))});a.privateMethodMap&&Object.keys(a.privateMethodMap).forEach(function(b){var d=
